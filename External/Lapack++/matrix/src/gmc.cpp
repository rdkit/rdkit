  ...
  LaGenMatComplex::LaGenMatComplex(COMPLEX *d, int m, int n) :v(d, m*n)
{
    if (debug())
    {
        std::cout << ">>> LaGenMatComplex::LaGenMatComplex(COMPLEX *d, int m, int n) :v(d, m*n)\n";
    }
...
if (debug())
{
        std::cout << ">>> LaGenMatComplex& LaGenMatComplex::operator=(COMPLEX s)\n";
        std::cout << "       s = " << s.real() << "+ i" << s.imag() << std::endl;
}
 ...
 LaGenMatComplex&  LaGenMatComplex::resize(const LaGenMatComplex &A)
{
    if (debug())
    {
		std::cout << ">>> resize(const LaGenMatComplex &A)" << std::endl;
...
LaGenMatComplex& LaGenMatComplex::copy(const LaGenMatComplex& X) 
{
    if (debug())
    {
        std::cout << ">>> LaGenMatComplex& LaGenMatComplex::copy\
