  ...
  LaGenMatLongInt::LaGenMatLongInt(long int *d, int m, int n) :v(d, m*n)
{
    if (debug())
    {
        std::cout << ">>> LaGenMatLongInt::LaGenMatLongInt(long int *d, int m, int n) :v(d, m*n)\n";
    }
...
if (debug())
{
        std::cout << ">>> LaGenMatLongInt& LaGenMatLongInt::operator=(long int s)\n";
 ...
 LaGenMatLongInt&  LaGenMatLongInt::resize(const LaGenMatLongInt &A)
{
    if (debug())
    {
        std::cout << ">>> resize(const LaGenMatLongInt &A)" << std::endl;
...
LaGenMatLongInt& LaGenMatLongInt::copy(const LaGenMatLongInt& X) 
{
    if (debug())
    {
        std::cout << ">>> LaGenMatLongInt& LaGenMatLongInt::copy\
...
std::ostream& operator<<(std::ostream& s, const LaGenMatLongInt& G)
{
