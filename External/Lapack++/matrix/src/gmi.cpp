  ...
  LaGenMatInt::LaGenMatInt(int *d, int m, int n) :v(d, m*n)
{
    if (debug())
    {
        std::cout << ">>> LaGenMatInt::LaGenMatInt(int *d, int m, int n) :v(d, m*n)\n";
    }
...
if (debug())
{
        std::cout << ">>> LaGenMatInt& LaGenMatInt::operator=(int s)\n";
 ...
 LaGenMatInt&  LaGenMatInt::resize(const LaGenMatInt &A)
{
    if (debug())
    {
        std::cout << ">>> resize(const LaGenMatInt &A)" << std::endl;
...
LaGenMatInt& LaGenMatInt::copy(const LaGenMatInt& X) 
{
    if (debug())
    {
        std::cout << ">>> LaGenMatInt& LaGenMatInt::copy\
(const LaGenMatInt& X)\n";
        std::cout << " X: " << X.info() << std::endl;
    }
