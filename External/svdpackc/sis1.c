...
float  timer(void);
void   ritzit( long , long , long , double , void (*) (long , double *, double *, double), void (*)(long , long , long , double *, long ),long , double **, double *, double *, double *, double *, long *);
...
/***************************************************************
 ...
 this program, alpha is determined by the matrix 1-norm of the

 user supplied routines: opb

 opb(nrow+ncol, x, y, alpha) takes an (nrow + ncol)-vector x 
 and should return B*x in y
 ...
 SIS1 development
 ----------------
 SIS1 is a C translation of the Fortran-77 SIS1 from the SVDPACK
...

{
   ...
   in1 = "sip1"     /* input parameters    */;
   in2 = "matrix"   /* matrix              */;
   out1 = "sio1"    /* results             */;
   out2 = "sio4"    /* info                */;
   out3 = "siv1"    /* singular vectors    */;
   ...
   /* read data */
     ...
     * u    - work array                                     (n)       *
     *******************************************************************/
	 size1 = sizeof(double) * (nnzero + p* 2 + 2 * n + NSIG * n);
   ...
   fprintf(fp_out1," ......    COMPUTED SINGULAR VALUES");
   fprintf(fp_out1,"  (RESIDUAL NORMS)\n ......");
...
/****************************************************************
 ...
 opb    the name of the subroutine that defines the matrix B. opb
        is called with the parameters (n, u, w, alpha) and must 
 ...
 inf    the name of the subroutine that may be used to obtain 
        ...
        called with parameters (ks, kg, kh, f, km), where ks
 ...
 **************************************************************/ 
void opb(long n,double *x, double *y , double Alpha)
