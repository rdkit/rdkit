...
int main(){
  ...
  BOOST_LOG(rdInfoLog) << " Test RealValue Vectors 1: Constructors and Accessing Values -------------------------------" << std::endl;
  test14RealVect();
  BOOST_LOG(rdInfoLog) << " Test RealValue Vectors 2: L1Norm -------------------------------" << std::endl;
  test15RealVectDists();
  BOOST_LOG(rdInfoLog) << " Test RealValue Vectors 3: Pickles -------------------------------" << std::endl;
