...
#ifndef RDKIT_INDEXING_SUITE_JDG20036_HPP
# define RDKIT_INDEXING_SUITE_JDG20036_HPP
...
namespace boost { namespace python {
    ...
    >
    class rdkit_indexing_suite
        : public def_visitor<
            rdkit_indexing_suite<
              Container
            , DerivedPolicies
            , NoProxy
            , NoSlice
        ...
        void visit(Class& cl) const
        {
            ...
            cl
                ...
                .def("__contains__", &base_contains)
                 ...
                 //  force python iterators to use getitem as opposed to the default iterator
            ;
...
#endif // RDKIT_INDEXING_SUITE_JDG20036_HPP
