/*
    RDBoost/boost_shared_ptr.h: Type caster for boost::shared_ptr<T>
    adapted from nanobind's type caster for std::shared_ptr<T>
    https://github.com/wjakob/nanobind/blob/master/include/nanobind/stl/shared_ptr.h
  ...
  static handle from_cpp(const Value &value, rv_policy,
    ...
    if (is_new) {
      ...
      if constexpr (std::is_const_v<T>)
        pp = boost::static_pointer_cast<void>(
