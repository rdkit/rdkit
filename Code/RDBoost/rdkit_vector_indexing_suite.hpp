...
#ifndef RDKIT_VECTOR_INDEXING_SUITE_JDG20036_HPP
# define RDKIT_VECTOR_INDEXING_SUITE_JDG20036_HPP

# include "rdkit_indexing_suite.hpp"
...
namespace boost { namespace python {
    ...
    class rdkit_vector_indexing_suite;
    
    namespace detail
    {
        template <class Container, bool NoProxy>
        class rdkit_final_vector_derived_policies 
            : public rdkit_vector_indexing_suite<Container, 
                NoProxy, rdkit_final_vector_derived_policies<Container, NoProxy> > {};
    }

    // The rdkit_vector_indexing_suite class is a predefined indexing_suite derived 
    ...
    //          .def(rdkit_vector_indexing_suite<std::vector<X> >())
    //      ;
    //
    ...
    template <
        ...
        class DerivedPolicies 
            = detail::rdkit_final_vector_derived_policies<Container, NoProxy> >
    class rdkit_vector_indexing_suite 
        : public rdkit_indexing_suite<Container, DerivedPolicies, NoProxy>
    {
    public:
...
#endif // RDKIT_VECTOR_INDEXING_SUITE_JDG20036_HPP
