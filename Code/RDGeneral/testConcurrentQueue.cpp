...
void testSomeProducerSomeConsumer() {
	...
	const int numConsumerThreads = (numToProduce * numProducerThreads)/numToConsume;
	...
	int expectedSum = (numToProduce*numProducerThreads) * (numToProduce*numProducerThreads + 1)/2;
