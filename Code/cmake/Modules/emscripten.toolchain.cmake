...
if (EMSCRIPTEN_ENABLE_EXCEPTIONS)
  # required to run tests
  set(EMSCRIPTEN_EXTRA "DISABLE_EXCEPTION_CATCHING=0")
endif()

if(EMSCRIPTEN_ASM_JS)
  set(EMSCRIPTEN_EXTRA "ASM_JS=1")
endif()

if (EMSCRIPTEN_EXTRA)
  set(EMSCRIPTEN_EXTRA "-s ${EMSCRIPTEN_EXTRA}")
endif()


set(CMAKE_C_FLAGS_RELEASE "-DNDEBUG -O2 ${EMSCRIPTEN_EXTRA}" CACHE STRING "Emscripten-overridden CMAKE_C_FLAGS_RELEASE")
set(CMAKE_C_FLAGS_MINSIZEREL "-DNDEBUG -Os ${EMSCRIPTEN_EXTRA}" CACHE STRING "Emscripten-overridden CMAKE_C_FLAGS_MINSIZEREL")
set(CMAKE_C_FLAGS_RELWITHDEBINFO "-O2 ${EMSCRIPTEN_EXTRA}" CACHE STRING "Emscripten-overridden CMAKE_C_FLAGS_RELWITHDEBINFO")
set(CMAKE_CXX_FLAGS_RELEASE "-DNDEBUG -O2 ${EMSCRIPTEN_EXTRA}" CACHE STRING "Emscripten-overridden CMAKE_CXX_FLAGS_RELEASE")
set(CMAKE_CXX_FLAGS_MINSIZEREL "-DNDEBUG -Os ${EMSCRIPTEN_EXTRA}" CACHE STRING "Emscripten-overridden CMAKE_CXX_FLAGS_MINSIZEREL")
set(CMAKE_CXX_FLAGS_RELWITHDEBINFO "-O2 ${EMSCRIPTEN_EXTRA}" CACHE STRING "Emscripten-overridden CMAKE_CXX_FLAGS_RELWITHDEBINFO")
