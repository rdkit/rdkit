...
#
#  The only difference between this and FindBoose
#   is that this package uses the exact BOOST_ROOT
#    BOOST_INCLUDEDIR and BOOST_LIBRARYDIR
#    on failure, the original FindBoost simply
#    fails far too often, even when given the exact
#    paths
#
# Use this module by invoking find_package with the form::
#
#   find_package(EmscriptenBoost
...
macro(_Boost_FIND_LIBRARY var)
  ...
  elseif(_Boost_FIND_LIBRARY_HINTS_FOR_COMPONENT)
    ...
    find_library(${var} HINTS ${_Boost_FIND_LIBRARY_HINTS_FOR_COMPONENT} ${ARGN})
      ...
      message("===>forcing ${BOOST_ROOT}/lib/libboost_regex.a")
      set(${var} "${BOOST_ROOT}/lib/libboost_regex.a")
  endif()
...
if(NOT Boost_INCLUDE_DIR)
  ...
  if ("${Boost_INCLUDE_DIR}" STREQUAL "" OR "${Boost_INCLUDE_DIR}" STREQUAL "Boost_INCLUDE_DIR-NOTFOUND")
    set (Boost_INCLUDE_DIR "${BOOST_ROOT}/include")
    message("== Forcing Boost Include dir to use specified root: ${Boost_INCLUDE_DIR}")
  endif()
endif()
...
foreach(COMPONENT ${Boost_FIND_COMPONENTS})
 ...
 MESSAGE("== ${_boost_LIBRARY_SEARCH_DIRS_tmp}")
 MESSAGE("== ${_boost_RELEASE_NAMES}")
