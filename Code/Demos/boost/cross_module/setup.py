...
setup(
  name="moda", version="1.0", ext_modules=[
    Extension("moda", ["moda.cpp"], include_dirs=incDirs, library_dirs=libDirs, libraries=libraries,
              extra_compile_args=compileArgs),
    Extension("modb", ["modb.cpp"], include_dirs=incDirs, library_dirs=libDirs, libraries=libraries,
              extra_compile_args=compileArgs)
  ])
