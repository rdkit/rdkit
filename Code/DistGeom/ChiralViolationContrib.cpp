...
ChiralViolationContrib::ChiralViolationContrib(ForceFields::ForceField *owner,
  ...
  URANGE_CHECK(cset->d_idx1 + 1, owner->positions().size());
  URANGE_CHECK(cset->d_idx2 + 1, owner->positions().size());
  URANGE_CHECK(cset->d_idx3 + 1, owner->positions().size());
  URANGE_CHECK(cset->d_idx4 + 1, owner->positions().size());
