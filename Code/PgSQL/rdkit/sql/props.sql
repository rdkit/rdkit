...
select mol_fmla('[2H]C([3H])O'::mol);
                                     -- separateIsotopes = true
select mol_fmla('[2H]C([3H])O'::mol, true);
                                           -- abbreviateHIsotopes = false
select mol_fmla('[2H]C([3H])O'::mol, true, false);
       --
select mol_fmla('[2H][13CH2]CO'::mol);
select mol_fmla('[2H][13CH2]CO'::mol, true);
select mol_fmla('[2H][13CH2]CO'::mol, true, false);
--
