...
MOLCATALOGLIBBASE=MolCatalog
RDMOLCATALOG=$(RDLIBDIR)/lib$(MOLCATALOGLIBBASE).so
RDMOLCATALOG_S=$(RDLIBDIR)/lib$(MOLCATALOGLIBBASE)_s.a

CHEMREACTIONLIBBASE=ChemReactions
RDCHEMREACTION=$(RDLIBDIR)/lib$(CHEMREACTIONLIBBASE).so
RDCHEMREACTION_S=$(RDLIBDIR)/lib$(CHEMREACTIONLIBBASE)_s.a
