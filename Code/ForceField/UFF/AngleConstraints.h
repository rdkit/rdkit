...
#ifndef __RD_UFFANGLECONSTRAINTS_H__
#define __RD_UFFANGLECONSTRAINTS_H__
#include <vector>
#include <iostream>
...
class RDKIT_FORCEFIELD_EXPORT AngleConstraintContribs
 ...
 private:
  ...
  std::tuple<RDGeom::Point3D, RDGeom::Point3D, RDGeom::Point3D> getPoints(
      double *pos, const AngleConstraintContribsParams &contrib) const;
  double computeAngleTerm(double angle,
