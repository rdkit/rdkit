...
/*!
  ...
  \param template_path the file path to a file containing the ring system templates.
...
*/
bool RDKIT_DEPICTOR_EXPORT setRingSystemTemplates(const std::string template_path);
