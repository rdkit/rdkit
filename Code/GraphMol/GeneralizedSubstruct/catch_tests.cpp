...
TEST_CASE("tautomer error") {
  ...
  SECTION("substructure matching and serialization") {
    ...
    CHECK(
        output ==
        "{\n    \"xqm_type\": \"3\",\n    \"tautomers\": [\n        {\n            \"pkl\": \"776t3gAAAAAQAAAAAgAAAAAAAAAHAAAABwAAAIABBgBgAAAAAQMGQCgAAAADBAdAKAAAAAMDB0A4AAAAAwEDBkAoAAAAAwQJACAAAAABBkBoAAAAAwMBCwABAAECaAwCA2gMAwRoDAQFAAQGaAwGAWgMQgEAAAAFAQIDBAYXBAAAAAAAAAAW\",\n            \"smiles\": \"Cc1cc(F)[nH]n1\"\n        },\n        {\n            \"pkl\": \"776t3gAAAAAQAAAAAgAAAAAAAAAHAAAABwAAAIABBgBgAAAAAQMGQCgAAAADBAdAOAAAAAMBAwdgKAAAAAMDBkAoAAAAAwQJACAAAAABBkBoAAAAAwMBCwABAAECaAwCA2gMAwRoDAQFAAQGaAwGAWgMQgEAAAAFAQIDBAYXBAAAAAAAAAAW\",\n            \"smiles\": \"Cc1cc(F)n[nH]1\"\n        }\n    ],\n    \"template\": {\n        \"pkl\": \"\",\n        \"smarts\": \"[#6]-[#6]1-,=,:[#7]:[#7]-,=,:[#6](-[#9])-,=,:[#6]-,=,:1\"\n    },\n    \"modifiedAtoms\": [\n        \"2\",\n        \"3\"\n    ],\n    \"modifiedBonds\": [\n        \"1\",\n        \"3\",\n        \"5\",\n        \"6\"\n    ]\n}\n");
  }
}
