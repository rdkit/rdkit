...
namespace RDKit
{
 namespace FMCS
 {
    ...
    public:
        ...
        ~SeedGrowThread() { stop(); join(); delete NewJobEvent;}
        ...
        bool isBusy()const              { return SeedToProceed != 0; }
        void setJob(const Seed* seed)   { SeedToProceed = seed; NewJobEvent->setSignal();}
        void stop() { StopSignal = true; if(NewJobEvent) NewJobEvent->setSignal();}
    };
