...
struct sgroup_wrap {
  static void wrap() {
    ...
    python::class_<SubstanceGroup, boost::shared_ptr<SubstanceGroup>>(
        ...
        .def("SetProp",
             (void(RDProps::*)(std::string_view, std::string, bool) const) &
                 SubstanceGroup::setProp<std::string>,
             (python::arg("self"), python::arg("key"), python::arg("val"),
              python::arg("computed") = false),
             "sets the value of a particular property")
        .def("SetDoubleProp",
             (void(RDProps::*)(std::string_view, double, bool) const) &
                 SubstanceGroup::setProp<double>,
             (python::arg("self"), python::arg("key"), python::arg("val"),
              python::arg("computed") = false),
             "sets the value of a particular property")
        .def("SetIntProp",
             (void(RDProps::*)(std::string_view, int, bool) const) &
                 SubstanceGroup::setProp<int>,
             (python::arg("self"), python::arg("key"), python::arg("val"),
              python::arg("computed") = false),
             "sets the value of a particular property")
        .def("SetUnsignedProp",
             (void(RDProps::*)(std::string_view, unsigned int, bool) const) &
                 SubstanceGroup::setProp<unsigned int>,
             (python::arg("self"), python::arg("key"), python::arg("val"),
              python::arg("computed") = false),
             "sets the value of a particular property")
        .def("SetBoolProp",
             (void(RDProps::*)(std::string_view, bool, bool) const) &
                 SubstanceGroup::setProp<bool>,
             (python::arg("self"), python::arg("key"), python::arg("val"),
              python::arg("computed") = false),
             "sets the value of a particular property")
        .def("HasProp",
             (bool(RDProps::*)(std::string_view) const) &
        ...
        .def("GetIntProp",
             (int(RDProps::*)(std::string_view) const) &
                 SubstanceGroup::getProp<int>,
             python::args("self", "key"),
             "returns the value of a particular property")
        .def("GetUnsignedProp",
             (unsigned int (RDProps::*)(std::string_view) const) &
                 SubstanceGroup::getProp<unsigned int>,
             python::args("self", "key"),
             "returns the value of a particular property")
        .def("GetDoubleProp",
             (double(RDProps::*)(std::string_view) const) &
        ...
        .def(
            "GetUnsignedVectProp",
            (std::vector<unsigned int>(RDProps::*)(std::string_view) const) &
                SubstanceGroup::getProp<std::vector<unsigned int>>,
            python::args("self", "key"),
            "returns the value of a particular property")
        .def("GetStringVectProp",
             (std::vector<std::string>(RDProps::*)(std::string_view) const) &
        ...
        .def("ClearProp",
             (void(RDProps::*)(std::string_view) const) &
