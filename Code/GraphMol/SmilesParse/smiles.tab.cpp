...
/* Line 268 of yacc.c  */
#line 128 "/scratch/RDKit_alternatevalence/Code/GraphMol/SmilesParse/smiles.tab.cpp"
...
/* Line 293 of yacc.c  */
#line 197 "/scratch/RDKit_alternatevalence/Code/GraphMol/SmilesParse/smiles.tab.cpp"
} YYSTYPE;
...
/* Line 343 of yacc.c  */
#line 209 "/scratch/RDKit_alternatevalence/Code/GraphMol/SmilesParse/smiles.tab.cpp"
...
static const yytype_uint16 yyrline[] =
{
     ...
     262,   271,   272,   273,   274,   275,   276,   277,   281,   282,
     283,   284,   285,   286,   287,   288,   289,   293,   294,   295,
     299,   300,   301,   302,   306,   307,   311,   312,   316,   317,
     321,   322,   325,   326
};
#endif
...
#line 255 "smiles.yy"
  ...
  if((yyval.atom)->getImplicitValence()==-1) (yyval.atom)->setNumImplicitHs(0);
...
/* Line 1806 of yacc.c  */
#line 283 "smiles.yy"
    { (yyval.atom) = new Atom(1); (yyval.atom)->setNumImplicitHs(1); }
    break;
...
/* Line 1806 of yacc.c  */
#line 284 "smiles.yy"
    { (yyval.atom) = new Atom(1); (yyval.atom)->setIsotope((yyvsp[(1) - (3)].ival)); (yyval.atom)->setNumImplicitHs(1);}
    break;
...
/* Line 1806 of yacc.c  */
#line 285 "smiles.yy"
    { (yyval.atom) = new Atom(1); (yyval.atom)->setNumImplicitHs((yyvsp[(3) - (3)].ival)); }
    break;
...
/* Line 1806 of yacc.c  */
#line 286 "smiles.yy"
    { (yyval.atom) = new Atom(1); (yyval.atom)->setIsotope((yyvsp[(1) - (4)].ival)); (yyval.atom)->setNumImplicitHs((yyvsp[(4) - (4)].ival));}
    break;
...
/* Line 1806 of yacc.c  */
#line 288 "smiles.yy"
    { (yyval.atom) = (yyvsp[(1) - (2)].atom); (yyvsp[(1) - (2)].atom)->setNumImplicitHs(1);}
    break;
...
/* Line 1806 of yacc.c  */
#line 289 "smiles.yy"
    { (yyval.atom) = (yyvsp[(1) - (3)].atom); (yyvsp[(1) - (3)].atom)->setNumImplicitHs((yyvsp[(3) - (3)].ival));}
    break;
...
/* Line 1806 of yacc.c  */
#line 1940 "/scratch/RDKit_alternatevalence/Code/GraphMol/SmilesParse/smiles.tab.cpp"
      default: break;
    }
