...
# define YY_CONSTEXPR
#endif
# include "smiles_location.tab.hpp"
...
switch (yykind)
    ...
    Parser (Scanner& token_scanner_yyarg, Builder& ast_yyarg);
    virtual ~Parser ();
    ...
    // Implementation of make_symbol for each token kind.
      ...
      static
      symbol_type
      make_HYDROGEN (std::string_view v, location_type l)
      {
        return symbol_type (token::HYDROGEN, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_HYDROGEN (const std::string_view& v, const location_type& l)
      {
        return symbol_type (token::HYDROGEN, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_AROMATIC_SYMBOL (std::string_view v, location_type l)
      {
        return symbol_type (token::AROMATIC_SYMBOL, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_AROMATIC_SYMBOL (const std::string_view& v, const location_type& l)
      {
        return symbol_type (token::AROMATIC_SYMBOL, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_ELEMENT_SYMBOL (std::string_view v, location_type l)
      {
        return symbol_type (token::ELEMENT_SYMBOL, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_ELEMENT_SYMBOL (const std::string_view& v, const location_type& l)
      {
        return symbol_type (token::ELEMENT_SYMBOL, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
