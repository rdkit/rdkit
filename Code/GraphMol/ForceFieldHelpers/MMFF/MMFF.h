  ...
  namespace MMFF {
    ...
    /*
      ...
      \return a pair with:
         ...
         second: the energy
    */
    std::pair<int,double> MMFFOptimizeMolecule(ROMol &mol, int maxIters=1000,
      ...
      if (mmffMolProperties.isValid()) {
        ForceFields::ForceField *ff=MMFF::constructForceField(mol,nonBondedThresh, confId,
...
#ifdef RDK_THREADSAFE_SSS
    namespace detail {
      void MMFFOptimizeMoleculeConfsHelper_(ForceFields::ForceField ff,
                                           ROMol *mol, 
