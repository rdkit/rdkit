...
// void GetMolFileBondStereoInfo(const Bond *bond, const INT_MAP_INT
// &wedgeBonds,
...
//         int bndIdx = Chirality::detail::pickBondToWedge(atom, mol,
//         nChiralNbrs,
//                                                         resSoFar, noNbrs);
...
//                                 stereoAts.end());
//           newSgs.emplace_back(StereoGroupType::STEREO_ABSOLUTE,
//           newStereoAtoms);
//         }
//       }
