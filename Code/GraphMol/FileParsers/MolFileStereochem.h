...
// RDKIT_FILEPARSERS_EXPORT void WedgeMolBonds(ROMol &mol, const Conformer
// *conf);
...
//  wavy
//    even if it connects to a chiral center or double bond with specified
//    stereo. one example of this would be the middle double bond in
//    C/C=C/C=C/C=C/C (if that's set to STEREOANY after constructing the
//    molecule) Otherwise, no wavy bond will be set
// */
