...
TEST_CASE("CDXML") {
    ...
    SECTION("ChemDraw Template from the synthesis-workshop") {
        ...
        std::vector<std::string> expected = {
            ...
            "Cc1ccc2ccc(=O)ccn12",
            "Cc1cccn1[C@H](C)[C@@H](C#N)O[Si](C)(C)C",
            "CC(C)[C@]1(O)[C@@H](OC(=O)c2ccc[nH]2)C2(O)C3(O)C45OC(O)(C[C@@]2(C)C4(O)CC[C@H](C)C5O)[C@@]31C",
    ...
    SECTION("ChemDraw Template 2 from the synthesis-workshop") {
        ...
        auto mols = CDXMLFileToMols(fname);
        std::vector<std::string> expected = {
            "CCN1CC2(COC)CC[C@@H](OC)C34C5CC6C(O)C5C(O)(C[C@@H]6OC)C(CC23)C14",
            "*",
            "C",
            "[F]",
            "[B]",
            ...
            "[2H]",
            "CCN1CC2(COC)CC[C@@H](OC)C34C5CC6C(O)C5C(O)(C[C@@H]6OC)C(CC23)C14",
            "CCN1CC2(COC)CCC(OC)C34C5CC6C(O)C5C(O)(C[C@H]6OC)C(CC23)C14",
            "*",
            "[B]",
            "[C]",
            "[2H]",
            ...
            "[C]",
            "[2H]",
            "CC(C)[C@]1(O)[C@@H](O)C2(O)C3(O)C45OC(O)(C[C@@]2(C)C4(O)CC[C@H](C)C5O)[C@@]31C",
            "CC1=C(C(C)C)[C@@H](O)C2(O)C1(O)C13OC(=O)C[C@@]2(C)C1(O)CC[C@H](C)C3O",
            "CC1=CC23OC(=O)C[C@@](C)(C2(O)CC1)C1(O)[C@H](O)[C@]2(C(C)C)O[C@]2(C)C31O",
            "*",
            "[B]",
            "[C]",
            "CC(C)[C@@H]1CC2C3C45C[C@@H](C)CCC4[C@]2(C)CC(O5)[C@@]31C",
            "[2H]",
            "*",
            "[B]",
            "[C]",
