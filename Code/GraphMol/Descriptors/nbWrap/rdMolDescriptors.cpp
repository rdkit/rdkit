...
RDKit::SparseIntVect<std::int32_t> *GetAtomPairFingerprint(
    ...
    const std::optional<PyIterableOf<std::uint32_t>> &ignoreAtoms,
    const std::optional<PyIterableOf<std::uint32_t>> &atomInvariants,
...
std::vector<double> CalcCustomPropVSA(const RDKit::ROMol &mol,
                                      ...
                                      const PyIterableOf<double> &bins,
                                      bool force) {
  std::vector<double> lbins;
  pythonObjectToVect<double>(bins, lbins);
...
NB_MODULE(rdMolDescriptors, m) {
  ...
  nb::class_<AtomPairsParameters>(m, "AtomPairsParameters")
      ...
      .def_prop_ro_static(
          "numPiBits", [](nb::object) { return RDKit::AtomPairs::numPiBits; })
      .def_prop_ro_static(
          "numBranchBits",
      ...
      .def_prop_ro_static("codeSize",
                          [](nb::object) { return RDKit::AtomPairs::codeSize; })
      .def_prop_ro_static("atomTypes", [](nb::object) { return atomPairTypes; })
      .def_prop_ro_static(
          "numPathBits",
          [](nb::object) { return RDKit::AtomPairs::numPathBits; })
      .def_prop_ro_static("numAtomPairFingerprintBits",
                          [](nb::object) {
  ...
  m.def(
      "GetAtomPairCode", RDKit::AtomPairs::getAtomPairCode, "atom1Code"_a,
      "atom2Code"_a, "distance"_a, "includeChirality"_a = false,
      R"DOC(Returns the atom-pair code (hash) for a pair of atoms separated by a
certain number of bonds)DOC");

  m.def(
      "GetAtomPairFingerprint", GetAtomPairFingerprint, "mol"_a,
      "minLength"_a = 1,
  ...
  m.def(
      "GetHashedAtomPairFingerprint", GetHashedAtomPairFingerprint, "mol"_a,
      "nBits"_a = 2048, "minLength"_a = 1,
      "maxLength"_a = (unsigned int)(RDKit::AtomPairs::maxPathLen - 1),
      "fromAtoms"_a = nb::none(), "ignoreAtoms"_a = nb::none(),
      "atomInvariants"_a = nb::none(), "includeChirality"_a = false,
      "use2D"_a = true, "confId"_a = -1,
  ...
  m.def(
      ...
      GetHashedAtomPairFingerprintAsBitVect, "mol"_a, "nBits"_a = 2048,
      "minLength"_a = 1,
      "maxLength"_a = (unsigned int)(RDKit::AtomPairs::maxPathLen - 1),
      "fromAtoms"_a = nb::none(), "ignoreAtoms"_a = nb::none(),
  ...
  m.def("GetHashedTopologicalTorsionFingerprint",
        GetHashedTopologicalTorsionFingerprint, "mol"_a, "nBits"_a = 2048,
        "targetSize"_a = 4, "fromAtoms"_a = nb::none(),
        "ignoreAtoms"_a = nb::none(), "atomInvariants"_a = nb::none(),
        "includeChirality"_a = false,
  ...
  m.def("GetHashedTopologicalTorsionFingerprintAsBitVect",
        GetHashedTopologicalTorsionFingerprintAsBitVect, "mol"_a,
        "nBits"_a = 2048, "targetSize"_a = 4, "fromAtoms"_a = nb::none(),
        "ignoreAtoms"_a = nb::none(), "atomInvariants"_a = nb::none(),
        "nBitsPerEntry"_a = 4, "includeChirality"_a = false,
        "Returns the topological-torsion fingerprint for a molecule as an "
        "ExplicitBitVect",
        nb::rv_policy::take_ownership);

  m.def("GetMorganFingerprint", GetMorganFingerprint, "mol"_a, "radius"_a,
        "invariants"_a = nb::none(), "fromAtoms"_a = nb::none(),
        "useChirality"_a = false, "useBondTypes"_a = true,
        "useFeatures"_a = false, "useCounts"_a = true, "bitInfo"_a = nb::none(),
        "includeRedundantEnvironments"_a = false,
        "Returns a Morgan fingerprint for a molecule",
        nb::rv_policy::take_ownership);

  m.def("GetHashedMorganFingerprint", GetHashedMorganFingerprint, "mol"_a,
        "radius"_a, "nBits"_a = 2048, "invariants"_a = nb::none(),
        "fromAtoms"_a = nb::none(), "useChirality"_a = false,
  ...
  m.def("GetMorganFingerprintAsBitVect", GetMorganFingerprintBV, "mol"_a,
        "radius"_a, "nBits"_a = 2048, "invariants"_a = nb::none(),
        "fromAtoms"_a = nb::none(), "useChirality"_a = false,
        "useBondTypes"_a = true, "useFeatures"_a = false,
        "bitInfo"_a = nb::none(), "includeRedundantEnvironments"_a = false,
  ...
  m.def("GetConnectivityInvariants", GetConnectivityInvariants, "mol"_a,
        "includeRingMembership"_a = true,
  ...
  m.def("GetFeatureInvariants", GetFeatureInvariants, "mol"_a,
  ...
  m.def("GetUSRDistributions", GetUSRDistributions, "coords"_a,
        "points"_a = nb::none(),
        "Returns the four USR distance distributions for a set of coordinates");

  m.def(
      "GetUSRDistributionsFromPoints", GetUSRDistributionsFromPoints,
      "coords"_a, "points"_a,
      "Returns the USR distance distributions for a set of coordinates and points");

  m.def("GetUSRFromDistributions", GetUSRFromDistributions, "distances"_a,
        "Returns the USR descriptor from a set of distance distributions");

  m.def("GetUSRScore", GetUSRScore, "descriptor1"_a, "descriptor2"_a,
        "weights"_a = nb::list(),
        "Returns the USR score for two USR or USRCAT descriptors");

  m.def("GetUSRCAT", GetUSRCAT, "mol"_a, "atomSelections"_a = nb::none(),
        "confId"_a = -1,
        "Returns a USRCAT descriptor for one conformer of a molecule");

  m.def("_CalcCrippenContribs", computeCrippenContribs, "mol"_a,
        "force"_a = false, "atomTypes"_a = nb::none(),
...
the Wildman-Cripppen logp and mr value)DOC");
  ...
  m.def("CalcCrippenDescriptors", calcCrippenDescriptors, "mol"_a,
        "includeHs"_a = true, "force"_a = false,
  ...
  m.def("CalcLabuteASA", RDKit::Descriptors::calcLabuteASA, "mol"_a,
        "includeHs"_a = true, "force"_a = false,
        "returns the Labute ASA value for a molecule");
  m.attr("_CalcLabuteASA_version") = RDKit::Descriptors::labuteASAVersion;

  m.def("_CalcLabuteASAContribs", computeASAContribs, "mol"_a,
        "includeHs"_a = true, "force"_a = false,
        "returns a list of atomic contributions to the Labute ASA");

  m.def("CalcTPSA", RDKit::Descriptors::calcTPSA, "mol"_a, "force"_a = false,
        "includeSandP"_a = false, "returns the TPSA value for a molecule");
  m.attr("_CalcTPSA_version") = RDKit::Descriptors::tpsaVersion;

  m.def("_CalcTPSAContribs", computeTPSAContribs, "mol"_a, "force"_a = false,
        "includeSandP"_a = false,
        "returns a list of atomic contributions to the TPSA");

  m.def("_CalcMolWt", RDKit::Descriptors::calcAMW, "mol"_a,
        "onlyHeavy"_a = false, "returns the molecule's molecular weight");
  m.attr("_CalcMolWt_version") = "1.0.0";

  m.def("CalcExactMolWt", RDKit::Descriptors::calcExactMW, "mol"_a,
        "onlyHeavy"_a = false, "returns the molecule's exact molecular weight");
  m.attr("_CalcExactMolWt_version") = "1.0.0";

  m.def("CalcMolFormula", RDKit::Descriptors::calcMolFormula, "mol"_a,
        "separateIsotopes"_a = false, "abbreviateHIsotopes"_a = true,
        "returns the molecule's formula");
  m.attr("_CalcMolFormula_version") = "1.3.0";

  m.def("CalcNumLipinskiHBD", RDKit::Descriptors::calcLipinskiHBD, "mol"_a,
  ...
  m.def("CalcNumLipinskiHBA", RDKit::Descriptors::calcLipinskiHBA, "mol"_a,
...
strict = NumRotatableBondsOptions.StrictLinkages - handles linkages between ring
  ...
  m.def("CalcNumRings", RDKit::Descriptors::calcNumRings, "mol"_a,
  ...
  m.def("CalcNumHeterocycles", RDKit::Descriptors::calcNumHeterocycles, "mol"_a,
  ...
  m.def("CalcNumAromaticHeterocycles",
        RDKit::Descriptors::calcNumAromaticHeterocycles, "mol"_a,
  ...
  m.def("CalcNumAromaticCarbocycles",
        RDKit::Descriptors::calcNumAromaticCarbocycles, "mol"_a,
  ...
  m.def("CalcNumSaturatedHeterocycles",
        RDKit::Descriptors::calcNumSaturatedHeterocycles, "mol"_a,
  ...
  m.def("CalcNumSaturatedCarbocycles",
        RDKit::Descriptors::calcNumSaturatedCarbocycles, "mol"_a,
  ...
  m.def("CalcNumAliphaticHeterocycles",
        RDKit::Descriptors::calcNumAliphaticHeterocycles, "mol"_a,
        "returns the number of aliphatic (containing at least one non-aromatic "
  ...
  m.def("CalcNumAliphaticCarbocycles",
        RDKit::Descriptors::calcNumAliphaticCarbocycles, "mol"_a,
        "returns the number of aliphatic (containing at least one non-aromatic "
  ...
  m.def("CalcNumAmideBonds", RDKit::Descriptors::calcNumAmideBonds, "mol"_a,
        "returns the number of amide bonds in a molecule");
  m.attr("_CalcNumAmideBonds_version") =
      RDKit::Descriptors::NumAmideBondsVersion;

  m.def("CalcFractionCSP3", RDKit::Descriptors::calcFractionCSP3, "mol"_a,
        "returns the fraction of C atoms that are SP3 hybridized");
  m.attr("_CalcFractionCSP3_version") = RDKit::Descriptors::FractionCSP3Version;

  m.def("SlogP_VSA_", CalcSlogPVSA, "mol"_a, "bins"_a = nb::none(),
        "force"_a = false,
        "returns the SlogP VSA contributions for a molecule");

  m.def("SMR_VSA_", CalcSMRVSA, "mol"_a, "bins"_a = nb::none(),
        "force"_a = false, "returns the SMR VSA contributions for a molecule");

  m.def("PEOE_VSA_", CalcPEOEVSA, "mol"_a, "bins"_a = nb::none(),
        "force"_a = false, "returns the PEOE VSA contributions for a molecule");

  m.def(
      "CustomProp_VSA_", CalcCustomPropVSA, "mol"_a, "customPropName"_a,
      "bins"_a, "force"_a = false,
      "returns the VSA contributions based on a custom property for a molecule");

  m.def("MQNs_", CalcMQNs, "mol"_a, "force"_a = false,
        "returns the MQN descriptors for a molecule");

  m.def("CalcChiNv", RDKit::Descriptors::calcChiNv, "mol"_a, "n"_a,
        "force"_a = false,
        "From equations (5),(9) and (10) of Rev. Comp. Chem. vol 2, 367-422, "
        "(1991)");
  m.attr("_CalcChiNv_version") = RDKit::Descriptors::chiNvVersion;

  m.def("CalcChi0v", RDKit::Descriptors::calcChi0v, "mol"_a, "force"_a = false,
        "From equations (5),(9) and (10) of Rev. Comp. Chem. vol 2, 367-422, "
        "(1991)");
  m.attr("_CalcChi0v_version") = RDKit::Descriptors::chi0vVersion;

  m.def("CalcChi1v", RDKit::Descriptors::calcChi1v, "mol"_a, "force"_a = false,
        "From equations (5),(9) and (10) of Rev. Comp. Chem. vol 2, 367-422, "
        "(1991)");
  m.attr("_CalcChi1v_version") = RDKit::Descriptors::chi1vVersion;

  m.def("CalcChi2v", RDKit::Descriptors::calcChi2v, "mol"_a, "force"_a = false,
        "From equations (5),(9) and (10) of Rev. Comp. Chem. vol 2, 367-422, "
        "(1991)");
  m.attr("_CalcChi2v_version") = RDKit::Descriptors::chi2vVersion;

  m.def("CalcChi3v", RDKit::Descriptors::calcChi3v, "mol"_a, "force"_a = false,
        "From equations (5),(9) and (10) of Rev. Comp. Chem. vol 2, 367-422, "
        "(1991)");
  m.attr("_CalcChi3v_version") = RDKit::Descriptors::chi3vVersion;

  m.def("CalcChi4v", RDKit::Descriptors::calcChi4v, "mol"_a, "force"_a = false,
        "From equations (5),(9) and (10) of Rev. Comp. Chem. vol 2, 367-422, "
        "(1991)");
  m.attr("_CalcChi4v_version") = RDKit::Descriptors::chi4vVersion;

  m.def("CalcChiNn", RDKit::Descriptors::calcChiNn, "mol"_a, "n"_a,
        "force"_a = false,
  ...
  m.def("CalcChi0n", RDKit::Descriptors::calcChi0n, "mol"_a, "force"_a = false,
        "Similar to ChiXv, but uses uses nVal instead of valence. This makes "
        "a big difference after we get out of the first row.");
  m.attr("_CalcChi0n_version") = RDKit::Descriptors::chi0nVersion;

  m.def("CalcChi1n", RDKit::Descriptors::calcChi1n, "mol"_a, "force"_a = false,
        "Similar to ChiXv, but uses uses nVal instead of valence. This makes "
        "a big difference after we get out of the first row.");
  m.attr("_CalcChi1n_version") = RDKit::Descriptors::chi1nVersion;

  m.def("CalcChi2n", RDKit::Descriptors::calcChi2n, "mol"_a, "force"_a = false,
        "Similar to ChiXv, but uses uses nVal instead of valence. This makes "
        "a big difference after we get out of the first row.");
  m.attr("_CalcChi2n_version") = RDKit::Descriptors::chi2nVersion;

  m.def("CalcChi3n", RDKit::Descriptors::calcChi3n, "mol"_a, "force"_a = false,
        "Similar to ChiXv, but uses uses nVal instead of valence. This makes "
        "a big difference after we get out of the first row.");
  m.attr("_CalcChi3n_version") = RDKit::Descriptors::chi3nVersion;

  m.def("CalcChi4n", RDKit::Descriptors::calcChi4n, "mol"_a, "force"_a = false,
        "Similar to ChiXv, but uses uses nVal instead of valence. This makes "
        "a big difference after we get out of the first row.");
  m.attr("_CalcChi4n_version") = RDKit::Descriptors::chi4nVersion;

  m.def("CalcHallKierAlpha", hkAlphaHelper, "mol"_a,
        "atomContribs"_a = nb::none(),
...
assigning hybridization)DOC");
  ...
  m.def(
      "CalcKappa1", RDKit::Descriptors::calcKappa1, "mol"_a,
...
assigning hybridization)DOC");
  ...
  m.def(
      "CalcKappa2", RDKit::Descriptors::calcKappa2, "mol"_a,
...
assigning hybridization)DOC");
  ...
  m.def(
      "CalcKappa3", RDKit::Descriptors::calcKappa3, "mol"_a,
...
assigning hybridization)DOC");
  ...
  m.def(
      "CalcPhi", RDKit::Descriptors::calcPhi, "mol"_a,
  ...
  m.def("GetMACCSKeysFingerprint",
        RDKit::MACCSFingerprints::getFingerprintAsBitVect, "mol"_a,
  ...
  m.def("GetAtomFeatures", GetAtomFeatures, "mol"_a, "atomid"_a,
        "addchiral"_a = false, "Returns the Atom Features vector");

  m.attr("_CalcNumSpiroAtoms_version") =
      RDKit::Descriptors::NumSpiroAtomsVersion;
  m.def("CalcNumSpiroAtoms", numSpiroAtoms, "mol"_a, "atoms"_a = nb::none(),
  ...
  m.def("CalcNumBridgeheadAtoms", numBridgeheadAtoms, "mol"_a,
        "atoms"_a = nb::none(),
  ...
  m.def("CalcNumAtomStereoCenters", RDKit::Descriptors::numAtomStereoCenters,
        "mol"_a,
...
for name, value in zip(properties.GetPropertyNames(), properties.ComputeProperties(mol)):
  print(name, value))DOC")
      ...
      .def("ComputeProperties",
           &RDKit::Descriptors::Properties::computeProperties, "mol"_a,
           "annotateMol"_a = false,
      ...
      .def_static(
          "GetProperty",
          [](const std::string &name) -> RDKit::Descriptors::PropertyFunctor * {
            return RDKit::Descriptors::Properties::getProperty(name).get();
          },
  ...
  m.def(
      "MakePropertyRangeQuery", RDKit::Descriptors::makePropertyRangeQuery,
...
query.Match( mol ))DOC",
  ...
  nb::class_<RDKit::Descriptors::DoubleCubicLatticeVolume>(
      ...
      .def(
          "__init__",
          [](RDKit::Descriptors::DoubleCubicLatticeVolume *self,
             const RDKit::ROMol &mol, const PyIterableOf<double> &radii,
             bool isProtein, bool includeLigand, double probeRadius,
             int confId) {
   ...
   - confId: conformer ID to consider (default=-1))DOC")
      ...
      .def("GetPartialVolume", &getPartialVolumeHelper, "atomIdx"_a,
  ...
  m.def("CalcCoulombMat", calcCoulombMat, "mol"_a, "confId"_a = -1,
        "Returns severals Coulomb randomized matrices");

  m.attr("_CalcEMMcharges_version") = RDKit::Descriptors::EEMVersion;
  m.def("CalcEEMcharges", calcEEMcharges, "mol"_a, "confId"_a = -1,
        "Returns EEM atomic partial charges");

  m.attr("_CalcWHIM_version") = RDKit::Descriptors::WHIMVersion;
  m.def("CalcWHIM", calcWHIMs, "mol"_a, "confId"_a = -1, "thresh"_a = 0.001,
        "CustomAtomProperty"_a = "", "Returns the WHIM descriptors vector");

  m.attr("_CalcGETAWAY_version") = RDKit::Descriptors::GETAWAYVersion;
  m.def("CalcGETAWAY", calcGETAWAYs, "mol"_a, "confId"_a = -1,
        "precision"_a = 2, "CustomAtomProperty"_a = "",
        "Returns the GETAWAY descriptors vector");

  m.attr("_CalcRDF_version") = RDKit::Descriptors::RDFVersion;
  m.def("CalcRDF", calcRDFs, "mol"_a, "confId"_a = -1,
  ...
  m.def("CalcMORSE", calcMORSEs, "mol"_a, "confId"_a = -1,
        "CustomAtomProperty"_a = "",
  ...
  m.def("CalcAUTOCORR3D", calcAUTOCORR3Ds, "mol"_a, "confId"_a = -1,
        "CustomAtomProperty"_a = "",
        "Returns 3D Autocorrelation descriptors vector");

  m.attr("_CalcPBF_version") = RDKit::Descriptors::PBFVersion;
  m.def("CalcPBF", RDKit::Descriptors::PBF, "mol"_a, "confId"_a = -1,
  ...
  m.def("CalcNPR1", RDKit::Descriptors::NPR1, "mol"_a, "confId"_a = -1,
        "useAtomicMasses"_a = true, "force"_a = true, "");

  m.attr("_CalcNPR2_version") = RDKit::Descriptors::NPR2Version;
  m.def("CalcNPR2", RDKit::Descriptors::NPR2, "mol"_a, "confId"_a = -1,
        "useAtomicMasses"_a = true, "force"_a = true, "");

  m.attr("_CalcPMI1_version") = RDKit::Descriptors::PMI1Version;
  m.def("CalcPMI1", RDKit::Descriptors::PMI1, "mol"_a, "confId"_a = -1,
        "useAtomicMasses"_a = true, "force"_a = true, "");

  m.attr("_CalcPMI2_version") = RDKit::Descriptors::PMI2Version;
  m.def("CalcPMI2", RDKit::Descriptors::PMI2, "mol"_a, "confId"_a = -1,
        "useAtomicMasses"_a = true, "force"_a = true, "");

  m.attr("_CalcPMI3_version") = RDKit::Descriptors::PMI3Version;
  m.def("CalcPMI3", RDKit::Descriptors::PMI3, "mol"_a, "confId"_a = -1,
        "useAtomicMasses"_a = true, "force"_a = true, "");

  m.attr("_CalcRadiusOfGyration_version") =
      RDKit::Descriptors::radiusOfGyrationVersion;
  m.def("CalcRadiusOfGyration", RDKit::Descriptors::radiusOfGyration, "mol"_a,
        "confId"_a = -1, "useAtomicMasses"_a = true, "force"_a = true, "");
  ...
  m.def("CalcInertialShapeFactor", RDKit::Descriptors::inertialShapeFactor,
        "mol"_a, "confId"_a = -1, "useAtomicMasses"_a = true, "force"_a = true,
        "");

  m.attr("_CalcEccentricity_version") = RDKit::Descriptors::eccentricityVersion;
  m.def("CalcEccentricity", RDKit::Descriptors::eccentricity, "mol"_a,
        "confId"_a = -1, "useAtomicMasses"_a = true, "force"_a = true, "");

  m.attr("_CalcAsphericity_version") = RDKit::Descriptors::asphericityVersion;
  m.def("CalcAsphericity", RDKit::Descriptors::asphericity, "mol"_a,
        "confId"_a = -1, "useAtomicMasses"_a = true, "force"_a = true, "");

  m.attr("_CalcSpherocityIndex_version") =
      RDKit::Descriptors::spherocityIndexVersion;
  m.def("CalcSpherocityIndex", RDKit::Descriptors::spherocityIndex, "mol"_a,
        "confId"_a = -1, "force"_a = true, "");

  m.attr("_CalcAUTOCORR2D_version") = RDKit::Descriptors::AUTOCORR2DVersion;
  m.def("CalcAUTOCORR2D", calcAUTOCORR2Ds, "mol"_a, "CustomAtomProperty"_a = "",
