...
RDKIT_GRAPHMOL_EXPORT void DetectAtomStereoChemistry(RWMol &mol,
...
RDKIT_GRAPHMOL_EXPORT void WedgeMolBonds(ROMol &mol, const Conformer *conf);
//! \deprecated use Chirality::wedgeBond instead
RDKIT_GRAPHMOL_EXPORT void WedgeBond(Bond *bond, unsigned int fromAtomIdx,
                                     const Conformer *conf);

struct RDKIT_GRAPHMOL_EXPORT StereoBondThresholds {
...
*/
RDKIT_GRAPHMOL_EXPORT void addWavyBondsForStereoAny(
...
RDKIT_GRAPHMOL_EXPORT INT_MAP_INT pickBondsToWedge(const ROMol &mol);
...
RDKIT_GRAPHMOL_EXPORT void markUnspecifiedStereoAsUnknown(ROMol &mol,
                                                          int confId = -1);
...
RDKIT_GRAPHMOL_EXPORT void reapplyMolBlockWedging(RWMol &mol);
...
*/
RDKIT_GRAPHMOL_EXPORT void translateChiralFlagToStereoGroups(
    ROMol &mol,
