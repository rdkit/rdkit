...
try:
  ...
  haveRdFingerprintGenerator = True
except ImportError:
  haveRdFingerprintGenerator = False
...
class TestCase(unittest.TestCase):
  ...
  @unittest.skipIf(not haveRdFingerprintGenerator,
                   "rdFingerprintGenerator not available in nanobind yet")
  def test1(self):
