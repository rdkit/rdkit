...
namespace RDKit{
  ...
  public:
    ...
    typedef enum {
      ...
      ATOM_DUMMYLABEL,
      BEGIN_ATOM_MONOMER,
      ATOM_PEPTIDE_RESIDUE_SERIALNUMBER,
      ATOM_PEPTIDE_RESIDUE_ALTLOC,
      ATOM_PEPTIDE_RESIDUE_RESIDUENAME,
      ATOM_PEPTIDE_RESIDUE_CHAINID,
      ATOM_PEPTIDE_RESIDUE_INSERTIONCODE,
      ATOM_PEPTIDE_RESIDUE_OCCUPANCY,
      ATOM_PEPTIDE_RESIDUE_TEMPFACTOR,
      ATOM_PEPTIDE_RESIDUE_ELEMENT,
      ATOM_PEPTIDE_RESIDUE_CHARGE,
      END_ATOM_MONOMER,
    } Tags;
