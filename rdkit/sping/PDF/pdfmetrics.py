...
could easily extend it to get the exact bounding box for each character useful for
kerning.


The ascent_descent attribute of the module is a dictionary mapping font names
(with the proper Postscript capitalization) to ascents and descents.  I ought
to sort out the font name case issue and the resolution of PIDDLE fonts to
