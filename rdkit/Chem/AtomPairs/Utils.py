...
def ExplainAtomCode(code, branchSubtract=0):  # pylint: disable=unused-argument
  """
...
def CosineSimilarity(v1, v2):
  ...
  **Notes**
  ...
  >>> CosineSimilarity( (1,2,3,4,10), (2,4,6) )
  0.516...
  >>> CosineSimilarity( (1,2,2,3,4), (2,2,4,5,6) )
  0.714...
  >>> CosineSimilarity( (1,2,2,3,4), (1,2,2,3,4) )
  1.0
  >>> CosineSimilarity( (1,2,2,3,4), (5,6,7) )
  0.0
  >>> CosineSimilarity( (1,2,2,3,4), () )
  0.0
