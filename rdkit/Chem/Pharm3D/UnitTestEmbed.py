...
class TestCase(unittest.TestCase):
  ...
  def test3Embed(self):
    testResults={
      'mol_197':(221.80,36.79,111.49,11.59,110.78,11.07,91.35,2.92,0.00),
      'mol_223':(267.42,7.44,139.48,1.57,139.41,1.57,90.34,0.61,0.00),
      'mol_269':(206.70,8.55,99.05,0.66,97.82,0.66,82.75,0.86,6.00),
      }
    inF = gzip.open(os.path.join(self.dataDir,'cdk2-syn-clip100.pkl.gz'),'rb')
    nDone = 0
    nHits = 0
