...
class CookieJar:
    ...
    def _cookies_for_domain(self, domain, request):
        ...
        if not self.policy.domain_return_ok(domain, request):
            return []
        ...
        for path in cookies_by_path.keys():
            if not self.policy.path_return_ok(path, request):
                continue
            for name, cookie in cookies_by_path[path].items():
                if not self.policy.return_ok(cookie, request):
    ...
    def add_cookie_header(self, request):
        ...
        get_header, header_items and add_unredirected_header, if it lacks those
    ...
    def set_cookie_if_ok(self, cookie, request):
        ...
        if self.policy.set_ok(cookie, request):
    ...
    # XXXX this breaks because name can be None!  get rid of this anonymous cookie nonsense!
