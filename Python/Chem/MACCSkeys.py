...
smartsPatts={
  ...
  41:('[#6]#[#7]',0), # CTN
  42:('F',0), # F
  43:('[!C;!c;!#1;!H0]~*~[!C;!c;!#1;!H0]',0), # QHAQH FIX: possibly incomplete
  44:('?',0), # OTHER
  45:('[#6]=[#6]~[#7]',0), # C=CN
  46:('Br',0), # BR
  47:('[#16]~*~[#7]',0), # SAN
  ...
  69:('[!#6;!#1]~[!#6;!#1;!H0]',0), # QQH FIX: possibly incomplete
  70:('[!#6;!#1]~[#7]~[!#6;!#1]',0), # QNQ
  71:('[#7]~[#8]',0), # NO
  72:('[#8]~*~*~[#8]',0), # OAAO
  73:('[#16]=*',0), # S=A
  ...
  119:('[#7]=*',0), # N=A
  120:('[!C;!c;R]',1), # Heterocyclic atom > 1 (&...) FIX: incomplete definition
  ...
  135:('[#7]!:*:*',0), # Nnot%A%A
  136:('[#8]=*',1), # O=A>1 FIX: maybe not right key
