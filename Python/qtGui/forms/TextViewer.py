...
class TextViewer(QMainWindow):
  def __init__(self,parent = None,name = None,fl = 0):
    ...
    if not name:
      self.setName("TextViewer")

    self.setIcon(self.image0)

    self.setCentralWidget(QWidget(self,"qt_central_widget"))
    TextViewerLayout = QVBoxLayout(self.centralWidget(),2,1,"TextViewerLayout")

    self.textBrowser = QTextBrowser(self.centralWidget(),"textBrowser")
    TextViewerLayout.addWidget(self.textBrowser)
    ...
    self.resize(QSize(612,480).expandedTo(self.minimumSizeHint()))
  ...
  def languageChange(self):
    self.setCaption(self.__tr("TextViewer"))
  ...
  def fileNew(self):
    print "TextViewer.fileNew(): Not implemented yet"

  def fileOpen(self):
    print "TextViewer.fileOpen(): Not implemented yet"

  def fileSave(self):
    print "TextViewer.fileSave(): Not implemented yet"

  def fileSaveAs(self):
    print "TextViewer.fileSaveAs(): Not implemented yet"

  def filePrint(self):
    print "TextViewer.filePrint(): Not implemented yet"

  def fileExit(self):
    print "TextViewer.fileExit(): Not implemented yet"

  def editUndo(self):
    print "TextViewer.editUndo(): Not implemented yet"

  def editRedo(self):
    print "TextViewer.editRedo(): Not implemented yet"

  def editCut(self):
    print "TextViewer.editCut(): Not implemented yet"

  def editCopy(self):
    print "TextViewer.editCopy(): Not implemented yet"

  def editPaste(self):
    print "TextViewer.editPaste(): Not implemented yet"

  def editFind(self):
    print "TextViewer.editFind(): Not implemented yet"

  def __tr(self,s,c = None):
    return qApp.translate("TextViewer",s,c)
