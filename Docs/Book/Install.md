...
Install the following packages using apt-get:
    ...
    sudo apt-get install flex bison build-essential python-numpy cmake python-dev sqlite3 libsqlite3-dev libboost-dev  libboost-python-dev libboost-regex-dev libeigen3-dev
