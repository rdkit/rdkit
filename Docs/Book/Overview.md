...
-   **PBF**: Plane of best fit
    ...
    1.  1.  Firth, N. Brown, and J. Blagg, "Plane of Best Fit: A Novel Method to Characterize the Three-Dimensionality of Molecules" *Journal of Chemical Information and Modeling* **52** 2516-2525 (2012). <http://pubs.acs.org/doi/abs/10.1021/ci300293f>
...
[2] These implementations are functional but are not necessarily the best, fastest, or most complete.

[3] These implementations are functional but are not necessarily the best, fastest, or most complete.

[4] Originally contributed by Andrew Dalke

[5] Putta, S., Eksterowicz, J., Lemmen, C. & Stanton, R. "A Novel Subshape Molecular Descriptor" *Journal of Chemical Information and Computer Sciences* **43:1623–35** (2003).

[6] These implementations are functional but are not necessarily the best, fastest, or most complete.

[7] Tosco, P., Balle, T. & Shiri, F. Open3DALIGN: an open-source software aimed at unsupervised ligand alignment. *J Comput Aided Mol Des* **25:777–83** (2011).

[8] Landrum, G., Penzotti, J. & Putta, S. "Feature-map vectors: a new class of informative descriptors for computational drug discovery" *Journal of Computer-Aided Molecular Design* **20:751–62** (2006).

[9] Nguyen, K. T., Blum, L. C., van Deursen, R. & Reymond, J.-L. Classification of Organic Molecules by Molecular Quantum Numbers. *ChemMedChem* **4:1803–5** (2009).

[10] Riniker, S. & Landrum, G. A. Similarity maps - a visualization strategy for molecular fingerprints and machine-learning methods. *Journal of Cheminformatics* **5:43** (2013).

[11] Schulz-Gasch, T., Schärfer, C., Guba, W. & Rarey, M. TFD: Torsion Fingerprints As a New Measure To Compare Small Molecule Conformations. *J. Chem. Inf. Model.* **52:1499–1512** (2012).
